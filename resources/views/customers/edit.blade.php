...
<div class="container mb-5" style="width: 60%;">
    <form method="POST" action="{{ route('customer.update',['id'=>$customer->id]) }} ">
        ...
        <div class="form-group mb-3">
            ...
            <input id="identificacion" type="text" class="form-control @error('identificacion') is-invalid @enderror" name="identificacion" value="{{ $customer->identificacion }}" required autocomplete="identificacion" autofocus>
        ...
        <div class="form-group mb-3">
            ...
            <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{$customer->address}}" autocomplete="address">
        ...
        <div class="form-group mb-3">
            ...
            <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{$customer->city}}" autocomplete="city">
        ...
        <div class="form-group mb-3">
            ...
            <input id="neighborhood" type="text" class="form-control @error('neighborhood') is-invalid @enderror" name="neighborhood" value="{{$customer->neighborhood}}" autocomplete="neighborhood">
