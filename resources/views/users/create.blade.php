            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="row mb-3">
                            <label for="identificacion" class="col-md-4 col-form-label text-md-end">Identificacion</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="file" class="form-control" name="photo" required autocomplete="photo">
                            </div>
                        </div>
